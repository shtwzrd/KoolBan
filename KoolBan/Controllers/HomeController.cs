...
namespace KoolBan.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                Description =
                    "synergistically actualize sustainable initiatives in order to promote sustainable synergy within the market of sticky e-commerce-based revolutionary metrics",
